...
class TestRandeerDefaultLoopingUsingObjectsGeneratorValidity(TestGeneratorValidity):
    abstract = False
    ...
    def _sample(self, min_: int, max_: int, excluded: tuple[int]):
        ...
        return self.sampler.sample_default_by_looping_using_objects(min_, max_, excluded)
